...
/**
 * @Description: 代码生成器生成类
 * @ClassName: DongBaoGenerator
 * @Author: xfeng
 * @Date: 2021/6/12 21:31
 * @Version: 1.0
 */
...
//        gc.setOutputDir("D:\\dongbao\\上课\\msb-dongbao-mall\\msb-dongbao-mall-parent-v1\\msb-dongbao-service\\msb-dongbao-ums\\src\\main\\java");
        gc.setOutputDir("D:\\ideaproject\\tongbao\\dongbao-mall-parent\\dongbao-service\\dongbao-ums\\src\\main\\java\\com\\xfeng");
        gc.setAuthor("xfeng");
        ...
        dsc.setUrl("jdbc:mysql://192.168.0.101:3306/product?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai");
